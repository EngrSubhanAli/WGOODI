...
class CustomSideBarDriver extends StatefulWidget {
  CustomSideBarDriver({Key? key}) : super(key: key);
  @override
  State<CustomSideBarDriver> createState() => _CustomSideBarDriverState();
}
class _CustomSideBarDriverState extends State<CustomSideBarDriver> {
  @override
        ...
        child: Column(
          children: [
            ...
            ListTile(
              ...
              title: Text("Ongoing Order",style:
              Theme.of(context).textTheme.bodyMedium!.copyWith(color: backgroundColor,fontWeight: FontWeight.bold,)),
              trailing: Icon(
                Icons.arrow_forward, // You can change this icon to the one you prefer
                color: backgroundColor,
            ...
            ListTile(
              onTap: (){
                Get.to(()=>PastOrderScreen(),transition: Transition.rightToLeft,duration: Duration(milliseconds: 300));
              },
              title: Text("Past Orders",style:
              Theme.of(context).textTheme.bodyMedium!.copyWith(color: backgroundColor,fontWeight: FontWeight.bold,),),
              trailing: Icon(
                Icons.arrow_forward, // You can change this icon to the one you prefer
                color: backgroundColor,
